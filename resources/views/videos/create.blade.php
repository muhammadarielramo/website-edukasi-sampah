                    ...
                    <form action="{{ route('videos.store') }}" method="POST" enctype="multipart/form-data" x-data="{ videoType: '{{ old('video_type', 'file') }}' }">
                        ...
                        <div class="mb-5 bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <div x-show="videoType === 'embed'" x-cloak class="mt-3">
                                ...
                                <textarea name="embed_code" id="embed_code" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 text-sm" placeholder="Paste URL YouTube/HeyGen/Vimeo atau kode <iframe src='...'></iframe>">{{ old('embed_code') }}</textarea>
